...
/* Remove the menu button so that it appears only when the screen is triggered */

const navLink = document.querySelectorAll('.nav__link')

function linkAction(){
    const navMenu = document.getElementById('nav-menu')
    /* Menu ke har element ko click karne par acc actions le sakte h */
    navMenu.classList.remove('show-menu')
}
...
sr.reveal(`.form__container`, {origin: 'right'})